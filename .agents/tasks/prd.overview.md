...
- Stories: 23 total (12 open, 1 in_progress, 10 done)
...
- [done] US-006: WebSocket server for real-time updates (depends on: US-005)
- [done] US-007: REST API endpoints for projects (depends on: US-003, US-004)
- [done] US-008: REST API endpoints for runs and logs (depends on: US-003, US-007)
- [done] US-009: CLI command: ralph dashboard (depends on: US-002, US-006, US-007, US-008)
